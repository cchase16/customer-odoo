...
The implementation contains a reusable form context-menu framework and
Navigation commands. Release-sensitive form-controller access remains in one
adapter; command behavior is contributed
